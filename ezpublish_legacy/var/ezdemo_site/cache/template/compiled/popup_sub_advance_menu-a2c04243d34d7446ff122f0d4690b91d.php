...
$oldSetArray_d083f07fd5939f5fb5dd9c39faf19674 = isset( $setArray ) ? $setArray : array();
$setArray = array();
$tpl->Level++;
if ( $tpl->Level > 40 )
{
...
menuArray[\'Advanced\'][\'elements\'][\'menu-hide\'] = { \'url\': "/index.php/ezdemo_admin/content/hide/%nodeID%" };
menuArray[\'Advanced\'][\'elements\'][\'menu-list\'] = { \'url\': "/index.php/ezdemo_admin/content/view/sitemap/%nodeID%" };
menuArray[\'Advanced\'][\'elements\'][\'reverse-related\'] = { \'url\': "/index.php/ezdemo_admin/content/reverserelatedlist/%nodeID%" };
menuArray[\'Advanced\'][\'elements\'][\'menu-history\'] = { \'url\': "/index.php/ezdemo_admin/content/history/%objectID%" };
menuArray[\'Advanced\'][\'elements\'][\'menu-url-alias\'] = { \'url\': "/index.php/ezdemo_admin/content/urlalias/%nodeID%" };
</script>
...
<form id="menu-form-swap" method="post" action="/index.php/ezdemo_admin/content/action">
...
$setArray = $oldSetArray_d083f07fd5939f5fb5dd9c39faf19674;
$tpl->Level--;
?>
