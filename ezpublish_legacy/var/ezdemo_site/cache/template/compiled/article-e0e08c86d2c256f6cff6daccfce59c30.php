<?php
// URI:       extension/ezdemo/design/ezdemo/override/templates/line/article.tpl
// Filename:  extension/ezdemo/design/ezdemo/override/templates/line/article.tpl
// Timestamp: 1417102386 (Thu Nov 27 16:33:06 CET 2014)
$oldSetArray_1600af7356a80de7b0b12a8dd67c1b4c = isset( $setArray ) ? $setArray : array();
$setArray = array();
$tpl->Level++;
if ( $tpl->Level > 40 )
{
...
if ( $tpl->hasVariable( 'content_size', $rootNamespace ) )
{
  ...
  2 => 'extension/ezdemo/design/ezdemo/override/templates/line/article.tpl',
) );
...
unset( $if_cond1 );
$if_cond1 = $if_cond2;
$if_cond2 = compiledFetchAttribute( $if_cond1, 'author' );
unset( $if_cond1 );
$if_cond1 = $if_cond2;
...
$setArray = $oldSetArray_1600af7356a80de7b0b12a8dd67c1b4c;
$tpl->Level--;
?>
