...
$oldSetArray_7948ea245f91b4cd2d801e2b3999b074 = isset( $setArray ) ? $setArray : array();
$setArray = array();
$tpl->Level++;
if ( $tpl->Level > 40 )
{
...
if ( $if_cond )
{
$text .= '    <div class="button-left"><a id="maincontent-show" class="show-hide-tabs" href="/index.php/ezdemo_admin/user/preferences/set/admin_navigation_content/1" title="Enable &quot;Tabs&quot; by default while browsing content.">&nbsp;</a></div>';
}
else
{
$text .= '    <div class="button-left"><a id="maincontent-hide" class="show-hide-tabs" href="/index.php/ezdemo_admin/user/preferences/set/admin_navigation_content/0" title="Disable &quot;Tabs&quot; by default while browsing content.">&nbsp;</a></div>';
}
unset( $if_cond );
// if ends
...
$text .= '    </li>
';
$oldRestoreIncludeArray_93b0bf0fc4576feb53bb686ec97b453e = isset( $restoreIncludeArray ) ? $restoreIncludeArray : array();
...
$resourceFound = false;
if ( file_exists( 'var/ezdemo_site/cache/template/compiled/window_controls_extratabs-ccc09f5be76d5d3e16c5086deb2c259f.php' ) )
{
$resourceFound = true;
...
include( '' . 'var/ezdemo_site/cache/template/compiled/window_controls_extratabs-ccc09f5be76d5d3e16c5086deb2c259f.php' );
...
$restoreIncludeArray = $oldRestoreIncludeArray_93b0bf0fc4576feb53bb686ec97b453e;
...
$text .= '<div class="tabs-content">
    ';
$oldRestoreIncludeArray_0b57e3ec3dbd9f6acee619de1d968471 = isset( $restoreIncludeArray ) ? $restoreIncludeArray : array();
$restoreIncludeArray = array();
...
$resourceFound = false;
if ( file_exists( 'var/ezdemo_site/cache/template/compiled/windows-929838a601e92c718f98a79273937f5c.php' ) )
{
$resourceFound = true;
$namespaceStack[] = array( $rootNamespace, $currentNamespace );
$rootNamespace = $currentNamespace;
...
include( '' . 'var/ezdemo_site/cache/template/compiled/windows-929838a601e92c718f98a79273937f5c.php' );
$tpl->unsetLocalVariables();
$tpl->destroyLocalVariablesList();
list( $rootNamespace, $currentNamespace ) = array_pop( $namespaceStack );
}
...
$restoreIncludeArray = $oldRestoreIncludeArray_0b57e3ec3dbd9f6acee619de1d968471;
...
$setArray = $oldSetArray_7948ea245f91b4cd2d801e2b3999b074;
$tpl->Level--;
?>
