...
$oldSetArray_eeff07c768facb1f38f7a3c8926b9206 = isset( $setArray ) ? $setArray : array();
$setArray = array();
$tpl->Level++;
if ( $tpl->Level > 40 )
{
...
$text .= '        var params = {"iconsList":[],"contentTreeUrl":"/ezdemo_admin/content/treemenu/","wwwDirPrefix":"/';
unset( $var );
unset( $var );
...
$setArray = $oldSetArray_eeff07c768facb1f38f7a3c8926b9206;
$tpl->Level--;
?>
