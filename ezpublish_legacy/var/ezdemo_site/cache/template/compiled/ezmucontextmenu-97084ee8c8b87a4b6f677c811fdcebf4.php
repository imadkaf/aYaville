...
$oldSetArray_c6e88d745786903f98650dfbdc76292c = isset( $setArray ) ? $setArray : array();
$setArray = array();
$tpl->Level++;
if ( $tpl->Level > 40 )
{
...
menuArray[\'ContextMenu\'][\'elements\'][\'menu-multiupload\'][\'url\'] = "/ezdemo_admin/ezmultiupload/upload/%nodeID%";
</script>

<a id="menu-multiupload" href="#" onmouseover="ezpopmenu_mouseOver( \'ContextMenu\' )" >Upload multiple files</a>';

$setArray = $oldSetArray_c6e88d745786903f98650dfbdc76292c;
$tpl->Level--;
?>
