...
$oldSetArray_6823c33787694a5039da77dc52d27fee = isset( $setArray ) ? $setArray : array();
$setArray = array();
$tpl->Level++;
if ( $tpl->Level > 40 )
{
...
$var2 = array( '%edition' => $var3, '%about_link' => "\"/index.php/ezdemo_admin/ezinfo/about\"" );unset( $var3 );
...
$setArray = $oldSetArray_6823c33787694a5039da77dc52d27fee;
$tpl->Level--;
?>
