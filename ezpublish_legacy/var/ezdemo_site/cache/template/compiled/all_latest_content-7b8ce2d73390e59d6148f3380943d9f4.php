...
$oldSetArray_dbc881ed6d47d2820a3e1a32ea90e391 = isset( $setArray ) ? $setArray : array();
$setArray = array();
$tpl->Level++;
if ( $tpl->Level > 40 )
{
...
$subtreeExpiry = NULL;
$cacheKeys = array( $cacheKeys, "3_0_3_36_design/standard/templates/dashboard/all_latest_content.tpl", "ezdemo_admin" );
...
{
$text .= '
<p>Latest content list is empty.</p>
';
}
unset( $if_cond );
// if ends
...
$setArray = $oldSetArray_dbc881ed6d47d2820a3e1a32ea90e391;
$tpl->Level--;
?>
