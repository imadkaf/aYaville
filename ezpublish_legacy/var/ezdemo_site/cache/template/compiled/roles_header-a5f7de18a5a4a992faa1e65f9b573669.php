<?php
// URI:       design:tabs/user/roles_header.tpl
// Filename:  design/admin/templates/tabs/user/roles_header.tpl
// Timestamp: 1416144920 (Sun Nov 16 14:35:20 CET 2014)
$oldSetArray_1b71d2375811cb449a180a4242a61b61 = isset( $setArray ) ? $setArray : array();
$setArray = array();
$tpl->Level++;
if ( $tpl->Level > 40 )
{
...
unset( $var3 );
unset( $var3 );
$var3 = ( array_key_exists( $rootNamespace, $vars ) and array_key_exists( 'assigned_roles', $vars[$rootNamespace] ) ) ? $vars[$rootNamespace]['assigned_roles'] : null;
...
$setArray = $oldSetArray_1b71d2375811cb449a180a4242a61b61;
$tpl->Level--;
?>
