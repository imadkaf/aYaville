...
$oldSetArray_6999ee8f060cda148467be5d069b0618 = isset( $setArray ) ? $setArray : array();
$setArray = array();
$tpl->Level++;
if ( $tpl->Level > 40 )
{
...
$subtreeExpiry = NULL;
$cacheKeys = array( $cacheKeys, "1_0_1_48_design/standard/templates/dashboard/latest_content.tpl", "ezdemo_admin" );
...
$text .= '">
                    <img src="/extension/ezdemo/design/ezdemo/images/edit.gif" width="16" height="16" alt="Edit" title="';
unset( $var );
unset( $var1 );
unset( $var3 );
unset( $var4 );
...
$var1 = strtr( 'Edit <%child_name>.', $var4 );
...
{
$text .= '                <img src="/design/standard/images/edit-disabled.gif" alt="Edit" title="';
unset( $var );
unset( $var1 );
unset( $var3 );
unset( $var4 );
...
$var1 = strtr( 'You do not have permission to edit <%child_name>.', $var4 );
unset( $var3, $var4, $var5, $var6 );
if (! isset( $var1 ) ) $var1 = NULL;
while ( is_object( $var1 ) and method_exists( $var1, 'templateValue' ) )
    $var1 = $var1->templateValue();
...
{
$text .= '
<p>Your latest content list is empty.</p>
';
}
unset( $if_cond );
// if ends
...
$setArray = $oldSetArray_6999ee8f060cda148467be5d069b0618;
$tpl->Level--;
?>
