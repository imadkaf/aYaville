...
$oldSetArray_aca579bec0ac3b6ad958b30fad9b22a1 = isset( $setArray ) ? $setArray : array();
$setArray = array();
$tpl->Level++;
if ( $tpl->Level > 40 )
{
...
$text .= '
<form name="translationsform" method="post" action="/index.php/ezdemo_admin/content/translation">
...
$setArray = $oldSetArray_aca579bec0ac3b6ad958b30fad9b22a1;
$tpl->Level--;
?>
