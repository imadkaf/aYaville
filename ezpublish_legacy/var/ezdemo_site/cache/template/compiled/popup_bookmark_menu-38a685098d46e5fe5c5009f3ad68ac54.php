...
$oldSetArray_721f44d593d23a5bed3b4e6686e2d24b = isset( $setArray ) ? $setArray : array();
$setArray = array();
$tpl->Level++;
if ( $tpl->Level > 40 )
{
...
menuArray[\'BookmarkMenu\'][\'elements\'][\'bookmark-view\'] = { \'url\': "/ezdemo_admin/content/view/full/%nodeID%" };
menuArray[\'BookmarkMenu\'][\'elements\'][\'bookmark-edit\'] = { \'url\': "/ezdemo_admin/content/edit/%objectID%" };
</script>
...
<form id="menu-form-removebookmark" method="post" action="/ezdemo_admin/content/bookmark">
...
$setArray = $oldSetArray_721f44d593d23a5bed3b4e6686e2d24b;
$tpl->Level--;
?>
