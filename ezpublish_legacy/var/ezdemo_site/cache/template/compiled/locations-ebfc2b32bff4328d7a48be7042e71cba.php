...
$oldSetArray_5812d3b1ef3206f56929afbe944e32af = isset( $setArray ) ? $setArray : array();
$setArray = array();
$tpl->Level++;
if ( $tpl->Level > 40 )
{
...
unset( $var );
$text .= '
<form name="locationsform" method="post" action="/index.php/ezdemo_admin/content/action">
...
$setArray = $oldSetArray_5812d3b1ef3206f56929afbe944e32af;
$tpl->Level--;
?>
