...
$oldSetArray_9c7d490110fa34b20e0cd2c032c4110b = isset( $setArray ) ? $setArray : array();
$setArray = array();
$tpl->Level++;
if ( $tpl->Level > 40 )
{
...
menuArray[\'Advanced\'][\'elements\'][\'menu-hide\'] = { \'url\': "/ezdemo_admin/content/hide/%nodeID%" };
menuArray[\'Advanced\'][\'elements\'][\'menu-list\'] = { \'url\': "/ezdemo_admin/content/view/sitemap/%nodeID%" };
menuArray[\'Advanced\'][\'elements\'][\'reverse-related\'] = { \'url\': "/ezdemo_admin/content/reverserelatedlist/%nodeID%" };
menuArray[\'Advanced\'][\'elements\'][\'menu-history\'] = { \'url\': "/ezdemo_admin/content/history/%objectID%" };
menuArray[\'Advanced\'][\'elements\'][\'menu-url-alias\'] = { \'url\': "/ezdemo_admin/content/urlalias/%nodeID%" };
</script>
...
<form id="menu-form-swap" method="post" action="/ezdemo_admin/content/action">
...
$setArray = $oldSetArray_9c7d490110fa34b20e0cd2c032c4110b;
$tpl->Level--;
?>
