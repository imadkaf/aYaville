...
$oldSetArray_c9ca9721f631bfe67b279ecd28e45992 = isset( $setArray ) ? $setArray : array();
$setArray = array();
$tpl->Level++;
if ( $tpl->Level > 40 )
{
...
<form id="menu-form-create-here" method="post" action="/index.php/ezdemo_admin/content/action">
...
$setArray = $oldSetArray_c9ca9721f631bfe67b279ecd28e45992;
$tpl->Level--;
?>
