...
$oldSetArray_5a2af4d74e51a8a4609bcc03e7eb8a7c = isset( $setArray ) ? $setArray : array();
$setArray = array();
$tpl->Level++;
if ( $tpl->Level > 40 )
{
...
$var1 = strtr( 'Edit <%draft_name>.', $var4 );
...
$text .= '">
                    <img src="/extension/ezdemo/design/ezdemo/images/edit.gif" width="16" height="16" border="0" alt="Edit" />
                </a>
            </td>
        </tr>
    ';
...
{
$text .= '
Currently you do not have any drafts available.
';
}
unset( $if_cond );
// if ends
...
$setArray = $oldSetArray_5a2af4d74e51a8a4609bcc03e7eb8a7c;
$tpl->Level--;
?>
