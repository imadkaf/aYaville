...
$oldSetArray_5c416be5d7fc8401e7a9573bd8a6f299 = isset( $setArray ) ? $setArray : array();
$setArray = array();
$tpl->Level++;
if ( $tpl->Level > 40 )
{
...
$textStack[] = $text;
$text = '';
$oldRestoreIncludeArray_e7b9d5459f539b7f1c43e0b7e1a9cc8d = isset( $restoreIncludeArray ) ? $restoreIncludeArray : array();
...
$resourceFound = false;
if ( file_exists( 'var/ezdemo_site/cache/template/compiled/page_head-c73538c6e8a6626c24196651ec00b461.php' ) )
{
$resourceFound = true;
...
include( '' . 'var/ezdemo_site/cache/template/compiled/page_head-c73538c6e8a6626c24196651ec00b461.php' );
...
$restoreIncludeArray = $oldRestoreIncludeArray_e7b9d5459f539b7f1c43e0b7e1a9cc8d;

$oldRestoreIncludeArray_a852ff26e0525de827d654ef32c44c7f = isset( $restoreIncludeArray ) ? $restoreIncludeArray : array();
$restoreIncludeArray = array();
...
$resourceFound = false;
if ( file_exists( 'var/ezdemo_site/cache/template/compiled/page_head_style-b6bd27b9d9a154c7a2e005d9619c243f.php' ) )
{
$resourceFound = true;
$namespaceStack[] = array( $rootNamespace, $currentNamespace );
$rootNamespace = $currentNamespace;
...
include( '' . 'var/ezdemo_site/cache/template/compiled/page_head_style-b6bd27b9d9a154c7a2e005d9619c243f.php' );
$tpl->unsetLocalVariables();
$tpl->destroyLocalVariablesList();
list( $rootNamespace, $currentNamespace ) = array_pop( $namespaceStack );
}
...
$restoreIncludeArray = $oldRestoreIncludeArray_a852ff26e0525de827d654ef32c44c7f;

$oldRestoreIncludeArray_cdf41cad10329cd85cf4ac38581ddddc = isset( $restoreIncludeArray ) ? $restoreIncludeArray : array();
$restoreIncludeArray = array();
...
$resourceFound = false;
if ( file_exists( 'var/ezdemo_site/cache/template/compiled/page_head_script-90fb06cff2eff7413a09f82e5decd858.php' ) )
{
$resourceFound = true;
$namespaceStack[] = array( $rootNamespace, $currentNamespace );
$rootNamespace = $currentNamespace;
...
include( '' . 'var/ezdemo_site/cache/template/compiled/page_head_script-90fb06cff2eff7413a09f82e5decd858.php' );
$tpl->unsetLocalVariables();
$tpl->destroyLocalVariablesList();
list( $rootNamespace, $currentNamespace ) = array_pop( $namespaceStack );
}
...
$restoreIncludeArray = $oldRestoreIncludeArray_cdf41cad10329cd85cf4ac38581ddddc;
...
';
$oldRestoreIncludeArray_dcb7c73c05fc2ebe14c0624228460ced = isset( $restoreIncludeArray ) ? $restoreIncludeArray : array();
$restoreIncludeArray = array();
...
$resourceFound = false;
if ( file_exists( 'var/ezdemo_site/cache/template/compiled/page_header-32a5f4b67a1da63dbc30b0d1d2b96c75.php' ) )
{
$resourceFound = true;
$namespaceStack[] = array( $rootNamespace, $currentNamespace );
$rootNamespace = $currentNamespace;
...
include( '' . 'var/ezdemo_site/cache/template/compiled/page_header-32a5f4b67a1da63dbc30b0d1d2b96c75.php' );
$tpl->unsetLocalVariables();
$tpl->destroyLocalVariablesList();
list( $rootNamespace, $currentNamespace ) = array_pop( $namespaceStack );
}
...
$restoreIncludeArray = $oldRestoreIncludeArray_dcb7c73c05fc2ebe14c0624228460ced;
...
$text .= '
';
$oldRestoreIncludeArray_05f4070f6c4b3ffaac65997da2660e25 = isset( $restoreIncludeArray ) ? $restoreIncludeArray : array();
$restoreIncludeArray = array();
...
$resourceFound = false;
if ( file_exists( 'var/ezdemo_site/cache/template/compiled/page_topmenu-c73c0ee454fd1f3be887fe7be6ce802a.php' ) )
{
$resourceFound = true;
$namespaceStack[] = array( $rootNamespace, $currentNamespace );
$rootNamespace = $currentNamespace;
...
include( '' . 'var/ezdemo_site/cache/template/compiled/page_topmenu-c73c0ee454fd1f3be887fe7be6ce802a.php' );
$tpl->unsetLocalVariables();
$tpl->destroyLocalVariablesList();
list( $rootNamespace, $currentNamespace ) = array_pop( $namespaceStack );
}
...
$restoreIncludeArray = $oldRestoreIncludeArray_05f4070f6c4b3ffaac65997da2660e25;
...
if ( $if_cond )
{
$text .= '    <a id="rightmenu-showhide" class="show-hide-control" title="Show / Hide rightmenu" href="/ezdemo_admin/user/preferences/set/admin_right_menu_show/1"></a>
    <div id="rightmenu-design"></div>';
}
else
{
$text .= '    <a id="rightmenu-showhide" class="show-hide-control" title="Hide / Show rightmenu" href="/ezdemo_admin/user/preferences/set/admin_right_menu_show/0"></a>
    <div id="rightmenu-design">
        ';
$oldRestoreIncludeArray_ce717fa91bb868f5e7498ef4ffbd3731 = isset( $restoreIncludeArray ) ? $restoreIncludeArray : array();
$restoreIncludeArray = array();
...
$resourceFound = false;
if ( file_exists( 'var/ezdemo_site/cache/template/compiled/admin_current_user-e9c48bde515a05e822a171e1b7d18fa0.php' ) )
{
$resourceFound = true;
$namespaceStack[] = array( $rootNamespace, $currentNamespace );
$rootNamespace = $currentNamespace;
...
include( '' . 'var/ezdemo_site/cache/template/compiled/admin_current_user-e9c48bde515a05e822a171e1b7d18fa0.php' );
$tpl->unsetLocalVariables();
$tpl->destroyLocalVariablesList();
list( $rootNamespace, $currentNamespace ) = array_pop( $namespaceStack );
}
...
$restoreIncludeArray = $oldRestoreIncludeArray_ce717fa91bb868f5e7498ef4ffbd3731;

$oldRestoreIncludeArray_a0b2e221bf3521687092d84fcf5272da = isset( $restoreIncludeArray ) ? $restoreIncludeArray : array();
$restoreIncludeArray = array();
...
$resourceFound = false;
if ( file_exists( 'var/ezdemo_site/cache/template/compiled/admin_preferences-7413913b97830e04240d3bbf45512afe.php' ) )
{
$resourceFound = true;
$namespaceStack[] = array( $rootNamespace, $currentNamespace );
$rootNamespace = $currentNamespace;
...
include( '' . 'var/ezdemo_site/cache/template/compiled/admin_preferences-7413913b97830e04240d3bbf45512afe.php' );
$tpl->unsetLocalVariables();
$tpl->destroyLocalVariablesList();
list( $rootNamespace, $currentNamespace ) = array_pop( $namespaceStack );
}
...
$restoreIncludeArray = $oldRestoreIncludeArray_a0b2e221bf3521687092d84fcf5272da;

$oldRestoreIncludeArray_3adba487a06d10c80c357db7ca9f471e = isset( $restoreIncludeArray ) ? $restoreIncludeArray : array();
$restoreIncludeArray = array();
...
$resourceFound = false;
if ( file_exists( 'var/ezdemo_site/cache/template/compiled/admin_bookmarks-329a0752badbd5e5489d87e2a7806910.php' ) )
{
$resourceFound = true;
$namespaceStack[] = array( $rootNamespace, $currentNamespace );
$rootNamespace = $currentNamespace;
...
include( '' . 'var/ezdemo_site/cache/template/compiled/admin_bookmarks-329a0752badbd5e5489d87e2a7806910.php' );
$tpl->unsetLocalVariables();
$tpl->destroyLocalVariablesList();
list( $rootNamespace, $currentNamespace ) = array_pop( $namespaceStack );
}
...
$restoreIncludeArray = $oldRestoreIncludeArray_3adba487a06d10c80c357db7ca9f471e;

$text .= '        ';
$oldRestoreIncludeArray_ee121f6a6984d4d980ac2d5fcd33ac63 = isset( $restoreIncludeArray ) ? $restoreIncludeArray : array();
$restoreIncludeArray = array();
...
$resourceFound = false;
if ( file_exists( 'var/ezdemo_site/cache/template/compiled/admin_clear_cache-b3b2f7adad78b0b5974d4833b9071f8b.php' ) )
{
$resourceFound = true;
$namespaceStack[] = array( $rootNamespace, $currentNamespace );
$rootNamespace = $currentNamespace;
...
include( '' . 'var/ezdemo_site/cache/template/compiled/admin_clear_cache-b3b2f7adad78b0b5974d4833b9071f8b.php' );
$tpl->unsetLocalVariables();
$tpl->destroyLocalVariablesList();
list( $rootNamespace, $currentNamespace ) = array_pop( $namespaceStack );
}
...
$restoreIncludeArray = $oldRestoreIncludeArray_ee121f6a6984d4d980ac2d5fcd33ac63;

$oldRestoreIncludeArray_f39777010a35ecea1ae4d9cda204b2f6 = isset( $restoreIncludeArray ) ? $restoreIncludeArray : array();
$restoreIncludeArray = array();
...
$resourceFound = false;
if ( file_exists( 'var/ezdemo_site/cache/template/compiled/admin_quick_settings-fa39eaf6adfde49270cea168fc9e601b.php' ) )
{
$resourceFound = true;
$namespaceStack[] = array( $rootNamespace, $currentNamespace );
$rootNamespace = $currentNamespace;
...
include( '' . 'var/ezdemo_site/cache/template/compiled/admin_quick_settings-fa39eaf6adfde49270cea168fc9e601b.php' );
$tpl->unsetLocalVariables();
$tpl->destroyLocalVariablesList();
list( $rootNamespace, $currentNamespace ) = array_pop( $namespaceStack );
}
...
$restoreIncludeArray = $oldRestoreIncludeArray_f39777010a35ecea1ae4d9cda204b2f6;
...
{
$text .= '    ';
$oldRestoreIncludeArray_7d0496cd11c711fa71ef955620a6a473 = isset( $restoreIncludeArray ) ? $restoreIncludeArray : array();
$restoreIncludeArray = array();
...
$resourceFound = false;
if ( file_exists( 'var/ezdemo_site/cache/template/compiled/page_leftmenu-b7184d75ba0471899c2c0e6f7d6fdf17.php' ) )
{
$resourceFound = true;
$namespaceStack[] = array( $rootNamespace, $currentNamespace );
$rootNamespace = $currentNamespace;
...
include( '' . 'var/ezdemo_site/cache/template/compiled/page_leftmenu-b7184d75ba0471899c2c0e6f7d6fdf17.php' );
$tpl->unsetLocalVariables();
$tpl->destroyLocalVariablesList();
list( $rootNamespace, $currentNamespace ) = array_pop( $namespaceStack );
}
...
$restoreIncludeArray = $oldRestoreIncludeArray_7d0496cd11c711fa71ef955620a6a473;
...
{
$text .= '    ';
$oldRestoreIncludeArray_e37694e1ae14a36e3efeb423d6f4c1b5 = isset( $restoreIncludeArray ) ? $restoreIncludeArray : array();
$restoreIncludeArray = array();
...
$resourceFound = false;
if ( file_exists( 'var/ezdemo_site/cache/template/compiled/page_mainarea-1bd259f26bbd48988ef32f1b674042fc.php' ) )
{
$resourceFound = true;
$namespaceStack[] = array( $rootNamespace, $currentNamespace );
$rootNamespace = $currentNamespace;
...
include( '' . 'var/ezdemo_site/cache/template/compiled/page_mainarea-1bd259f26bbd48988ef32f1b674042fc.php' );
$tpl->unsetLocalVariables();
$tpl->destroyLocalVariablesList();
list( $rootNamespace, $currentNamespace ) = array_pop( $namespaceStack );
}
...
$restoreIncludeArray = $oldRestoreIncludeArray_e37694e1ae14a36e3efeb423d6f4c1b5;
...
$text .= '    <div id="maincontent">
    ...
    <div id="path">
        <div id="path-design">
            ';
$oldRestoreIncludeArray_b04936e9c60bd312257bcb931c41fa15 = isset( $restoreIncludeArray ) ? $restoreIncludeArray : array();
$restoreIncludeArray = array();
...
$resourceFound = false;
if ( file_exists( 'var/ezdemo_site/cache/template/compiled/page_toppath-9d451e71a6022859e875ab7d08c2ea80.php' ) )
{
$resourceFound = true;
$namespaceStack[] = array( $rootNamespace, $currentNamespace );
$rootNamespace = $currentNamespace;
...
include( '' . 'var/ezdemo_site/cache/template/compiled/page_toppath-9d451e71a6022859e875ab7d08c2ea80.php' );
$tpl->unsetLocalVariables();
$tpl->destroyLocalVariablesList();
list( $rootNamespace, $currentNamespace ) = array_pop( $namespaceStack );
}
...
$restoreIncludeArray = $oldRestoreIncludeArray_b04936e9c60bd312257bcb931c41fa15;
...
$text .= '        </div>
    ...
    <!-- Maincontent START -->
    ';
$oldRestoreIncludeArray_cae90577a2c3cc8fdcea8e8e571ea40f = isset( $restoreIncludeArray ) ? $restoreIncludeArray : array();
$restoreIncludeArray = array();
...
$restoreIncludeArray = $oldRestoreIncludeArray_cae90577a2c3cc8fdcea8e8e571ea40f;
...
<div id="footer-design">
    ';
$oldRestoreIncludeArray_4c2bf1ba4772e85f75c1c0e0af29d11b = isset( $restoreIncludeArray ) ? $restoreIncludeArray : array();
$restoreIncludeArray = array();
...
$resourceFound = false;
if ( file_exists( 'var/ezdemo_site/cache/template/compiled/page_copyright-27e321cbe8b7e9b3173bc4d49f491f43.php' ) )
{
$resourceFound = true;
$namespaceStack[] = array( $rootNamespace, $currentNamespace );
$rootNamespace = $currentNamespace;
...
include( '' . 'var/ezdemo_site/cache/template/compiled/page_copyright-27e321cbe8b7e9b3173bc4d49f491f43.php' );
$tpl->unsetLocalVariables();
$tpl->destroyLocalVariablesList();
list( $rootNamespace, $currentNamespace ) = array_pop( $namespaceStack );
}
...
$restoreIncludeArray = $oldRestoreIncludeArray_4c2bf1ba4772e85f75c1c0e0af29d11b;
...
';
$oldRestoreIncludeArray_31290c2a933049e5ab278c34e400a706 = isset( $restoreIncludeArray ) ? $restoreIncludeArray : array();
$restoreIncludeArray = array();
...
$resourceFound = false;
if ( file_exists( 'var/ezdemo_site/cache/template/compiled/popup_menu-675e650db61e1d451d38993f60810c1e.php' ) )
{
$resourceFound = true;
$namespaceStack[] = array( $rootNamespace, $currentNamespace );
$rootNamespace = $currentNamespace;
...
include( '' . 'var/ezdemo_site/cache/template/compiled/popup_menu-675e650db61e1d451d38993f60810c1e.php' );
$tpl->unsetLocalVariables();
$tpl->destroyLocalVariablesList();
list( $rootNamespace, $currentNamespace ) = array_pop( $namespaceStack );
}
...
$restoreIncludeArray = $oldRestoreIncludeArray_31290c2a933049e5ab278c34e400a706;
...
$setArray = $oldSetArray_5c416be5d7fc8401e7a9573bd8a6f299;
$tpl->Level--;
?>
