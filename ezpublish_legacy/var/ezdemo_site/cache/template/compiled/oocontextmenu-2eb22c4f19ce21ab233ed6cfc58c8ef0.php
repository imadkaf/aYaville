...
$oldSetArray_cd956ccdcecfe15ec9258f4a6ac26687 = isset( $setArray ) ? $setArray : array();
$setArray = array();
$tpl->Level++;
if ( $tpl->Level > 40 )
{
...
<form id="menu-form-export-ooo" method="post" action="/ezdemo_admin/ezodf/export">
...
<form id="menu-form-export-pdf" method="post" action="/ezdemo_admin/ezodf/export">
...
<form id="menu-form-export-word" method="post" action="/ezdemo_admin/ezodf/export">
...
<form id="menu-form-import-ooo" method="post" action="/ezdemo_admin/ezodf/import">
  <input type="hidden" name="NodeID" value="%nodeID%" />
  <input type="hidden" name="ObjectID" value="%objectID%" />
  <input type="hidden" name="CurrentURL" value="%currentURL%" />
</form>
...
<form id="menu-form-replace-ooo" method="post" action="/ezdemo_admin/ezodf/import">
...
$setArray = $oldSetArray_cd956ccdcecfe15ec9258f4a6ac26687;
$tpl->Level--;
?>
