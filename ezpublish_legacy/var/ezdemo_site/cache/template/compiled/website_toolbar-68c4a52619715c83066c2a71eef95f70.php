<?php
// URI:       design:parts/website_toolbar.tpl
...
$oldSetArray_3e9499999f2a471415af14dce81e9c0d = isset( $setArray ) ? $setArray : array();
$setArray = array();
$tpl->Level++;
if ( $tpl->Level > 40 )
{
...
unset( $var );
unset( $var1 );
$var1 = call_user_func_array( array( new eZUserFunctionCollection(), 'fetchCurrentUser' ),
  array(  ) );
...
';
$oldRestoreIncludeArray_775c0123fa456b8f44012e164be2d0ef = isset( $restoreIncludeArray ) ? $restoreIncludeArray : array();
...
$resourceFound = false;
if ( file_exists( 'var/ezdemo_site/cache/template/compiled/logo-e27488a03943fcb0d7714c6d85bf0952.php' ) )
{
$resourceFound = true;
...
include( '' . 'var/ezdemo_site/cache/template/compiled/logo-e27488a03943fcb0d7714c6d85bf0952.php' );
...
$restoreIncludeArray = $oldRestoreIncludeArray_775c0123fa456b8f44012e164be2d0ef;
...
$text .= '  <input type="hidden" name="ContentLanguageCode" value="eng-GB" />
  <input class="ezwt-input-image" type="image" src="/extension/ezwt/design/standard/images/websitetoolbar/ezwt-icon-create.png" name="NewButton" title="Create here" />
</div>';
}
unset( $if_cond );
// if ends
...
if ( $if_cond )
{
$text .= '    <input type="hidden" name="ContentObjectLanguageCode" value="eng-GB" />
    <input class="ezwt-input-image" type="image" src="/extension/ezwt/design/standard/images/websitetoolbar/ezwt-icon-edit.png" name="EditButton" title="Edit';
unset( $var );
unset( $var );
...
if ( $if_cond )
{
$text .= '    <input class="ezwt-input-image" type="image" src="/extension/ezwt/design/standard/images/websitetoolbar/ezwt-icon-move.png" name="MoveNodeButton" title="Move';
unset( $var );
unset( $var );
$var = ( array_key_exists( $rootNamespace, $vars ) and array_key_exists( 'node_hint', $vars[$rootNamespace] ) ) ? $vars[$rootNamespace]['node_hint'] : null;
if (! isset( $var ) ) $var = NULL;
...
if ( $if_cond )
{
$text .= '    <input class="ezwt-input-image" type="image" src="/extension/ezwt/design/standard/images/websitetoolbar/ezwt-icon-remove.png" name="ActionRemove" title="Remove';
unset( $var );
unset( $var );
$var = ( array_key_exists( $rootNamespace, $vars ) and array_key_exists( 'node_hint', $vars[$rootNamespace] ) ) ? $vars[$rootNamespace]['node_hint'] : null;
if (! isset( $var ) ) $var = NULL;
...
if ( $if_cond )
{
$text .= '        <input class="ezwt-input-image" type="image" src="/extension/ezwt/design/standard/images/websitetoolbar/ezwt-icon-locations.png" name="AddAssignmentButton" title="Add locations" />
    ';
}
else
{
$text .= '        <input class="ezwt-input-image disabled" type="image" src="/extension/ezwt/design/standard/images/websitetoolbar/ezwt-icon-locations-disabled.png" name="AddAssignmentButton" title="Add locations" disabled="disabled" />
    ';
}
unset( $if_cond );
// if ends
...
$text .= ' title="Sorting"><img src="/extension/ezwt/design/standard/images/websitetoolbar/ezwt-icon-sort.png" alt="Sorting" /></a>
...
';
// if begins
$if_cond = 'http://192.168.56.102/index.php/ezdemo_admin/user/login';
if ( $if_cond )
{
$text .= '
    <a href="';
unset( $var );
$var = array (
  0 => 'http://192.168.56.102/index.php/ezdemo_admin/',
  1 => '',
);
...
$text .= '" target="_blank" title="Go to admin interface."><img src="/extension/ezwt/design/standard/images/websitetoolbar/ezwt-icon-admin.png" alt="Go to admin interface." /></a>';
}
unset( $if_cond );
// if ends
...
$text .= '" />
  <input type="image" class="ezwt-input-image" src="/extension/ezwt/design/standard/images/websitetoolbar/ezwt-icon-replace.png" name="ReplaceAction" title="Replace" />
</form>';
}
unset( $if_cond );
// if ends
...
$text .= '" />
  <input type="image" class="ezwt-input-image" src="/extension/ezwt/design/standard/images/websitetoolbar/ezwt-icon-export.png" name="ExportAction" title="Export" />
</form>';
}
unset( $if_cond );
// if ends
...
$text .= '" />
  <input type="image" class="ezwt-input-image" src="/extension/ezwt/design/standard/images/websitetoolbar/ezwt-icon-import.png" name="ImportAction" title="Import" />
</form>';
}
unset( $if_cond );
// if ends
...
$oldRestoreIncludeArray_5ebc952d409475d2b4e14350710ea580 = isset( $restoreIncludeArray ) ? $restoreIncludeArray : array();
$restoreIncludeArray = array();
...
$resourceFound = false;
if ( file_exists( 'var/ezdemo_site/cache/template/compiled/help-607ec93be3df12371449b347a050687e.php' ) )
{
$resourceFound = true;
$namespaceStack[] = array( $rootNamespace, $currentNamespace );
$rootNamespace = $currentNamespace;
...
include( '' . 'var/ezdemo_site/cache/template/compiled/help-607ec93be3df12371449b347a050687e.php' );
$tpl->unsetLocalVariables();
$tpl->destroyLocalVariablesList();
list( $rootNamespace, $currentNamespace ) = array_pop( $namespaceStack );
}
...
$restoreIncludeArray = $oldRestoreIncludeArray_5ebc952d409475d2b4e14350710ea580;
...
';
$oldRestoreIncludeArray_4353c90b32ba02202a7752ddd57d3f51 = isset( $restoreIncludeArray ) ? $restoreIncludeArray : array();
$restoreIncludeArray = array();
...
$resourceFound = false;
if ( file_exists( 'var/ezdemo_site/cache/template/compiled/floating_toolbar-fac1b5af2b39ffb8049ec8e13e06f7af.php' ) )
{
$resourceFound = true;
$namespaceStack[] = array( $rootNamespace, $currentNamespace );
$rootNamespace = $currentNamespace;
...
include( '' . 'var/ezdemo_site/cache/template/compiled/floating_toolbar-fac1b5af2b39ffb8049ec8e13e06f7af.php' );
$tpl->unsetLocalVariables();
$tpl->destroyLocalVariablesList();
list( $rootNamespace, $currentNamespace ) = array_pop( $namespaceStack );
}
...
$restoreIncludeArray = $oldRestoreIncludeArray_4353c90b32ba02202a7752ddd57d3f51;
...
$setArray = $oldSetArray_3e9499999f2a471415af14dce81e9c0d;
$tpl->Level--;
?>
