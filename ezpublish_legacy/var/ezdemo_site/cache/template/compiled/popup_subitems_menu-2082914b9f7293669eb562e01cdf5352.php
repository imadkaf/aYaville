...
$oldSetArray_88bc41b2313d82bf5b9d9399b7f10884 = isset( $setArray ) ? $setArray : array();
$setArray = array();
$tpl->Level++;
if ( $tpl->Level > 40 )
{
...
//menuArray[\'SubitemsContextMenu\'][\'elements\'][\'child-menu-view\'] = { \'url\': "/index.php/ezdemo_admin/content/view/full/%nodeID%" };
menuArray[\'SubitemsContextMenu\'][\'elements\'][\'child-menu-preview\'] = { \'url\': "/index.php/ezdemo_admin/content/versionview/%objectID%/%version%" };
menuArray[\'SubitemsContextMenu\'][\'elements\'][\'child-menu-edit\'] = { \'url\': "/index.php/ezdemo_admin/content/edit/%objectID%" };
menuArray[\'SubitemsContextMenu\'][\'elements\'][\'child-menu-copy\'] = { \'url\': "/index.php/ezdemo_admin/content/copy/%objectID%" };
menuArray[\'SubitemsContextMenu\'][\'elements\'][\'child-menu-copy-subtree\'] = { \'url\': "/index.php/ezdemo_admin/content/copysubtree/%nodeID%" };
...
$setArray = $oldSetArray_88bc41b2313d82bf5b9d9399b7f10884;
$tpl->Level--;
?>
