...
$oldSetArray_88113d23f340c8bd25957f281f1cfa5d = isset( $setArray ) ? $setArray : array();
$setArray = array();
$tpl->Level++;
if ( $tpl->Level > 40 )
{
...
<form action="/index.php/ezdemo_admin/content/search" method="get">
    ';
// if begins
unset( $if_cond );
unset( $if_cond );
...
{
$text .= '            <p class="advanced hide"><a href="/index.php/ezdemo_admin/content/advancedsearch" title="Advanced search.">Advanced</a></p>
        ';
}
unset( $if_cond );
// if ends
...
$setArray = $oldSetArray_88113d23f340c8bd25957f281f1cfa5d;
$tpl->Level--;
?>
