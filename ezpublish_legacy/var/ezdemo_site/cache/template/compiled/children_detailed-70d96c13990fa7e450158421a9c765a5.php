...
$oldSetArray_07dcff825bf6460a960bdbf004fa2ec1 = isset( $setArray ) ? $setArray : array();
$setArray = array();
$tpl->Level++;
if ( $tpl->Level > 40 )
{
...
$text .= '",
    editPrefixURL: "/ezdemo_admin/content/edit",
    rowsPrPage: ';
unset( $var );
unset( $var );
...
$setArray = $oldSetArray_07dcff825bf6460a960bdbf004fa2ec1;
$tpl->Level--;
?>
