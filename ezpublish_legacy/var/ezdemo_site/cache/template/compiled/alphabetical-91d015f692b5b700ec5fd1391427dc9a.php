...
$oldSetArray_4a5ef2aaea6b00bc94ecd3961c98fa26 = isset( $setArray ) ? $setArray : array();
$setArray = array();
$tpl->Level++;
if ( $tpl->Level > 40 )
{
...
{
$text .= '    ';
$oldRestoreIncludeArray_28464afb14de3ce01b327856c8b64cfd = isset( $restoreIncludeArray ) ? $restoreIncludeArray : array();
...
$restoreIncludeArray = $oldRestoreIncludeArray_28464afb14de3ce01b327856c8b64cfd;
...
$setArray = $oldSetArray_4a5ef2aaea6b00bc94ecd3961c98fa26;
$tpl->Level--;
?>
