...
$oldSetArray_e7c6d79fb177d5215a54e6684e6ee169 = isset( $setArray ) ? $setArray : array();
$setArray = array();
$tpl->Level++;
if ( $tpl->Level > 40 )
{
...
unset( $var );
$text .= '
<form name="locationsform" method="post" action="/ezdemo_admin/content/action">
...
$setArray = $oldSetArray_e7c6d79fb177d5215a54e6684e6ee169;
$tpl->Level--;
?>
