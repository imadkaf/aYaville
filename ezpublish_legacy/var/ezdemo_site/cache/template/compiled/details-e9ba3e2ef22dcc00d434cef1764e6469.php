...
$oldSetArray_e5968317bdc5cfff7634b1369fec243c = isset( $setArray ) ? $setArray : array();
$setArray = array();
$tpl->Level++;
if ( $tpl->Level > 40 )
{
...
<form name="statesform" method="post" action="/ezdemo_admin/state/assign">
...
unset( $var2 );
unset( $var3 );
$var3 = ( '<a href=' . '"/ezdemo_admin/state/groups"' . '>' );
if (! isset( $var3 ) ) $var3 = NULL;
while ( is_object( $var3 ) and method_exists( $var3, 'templateValue' ) )
    $var3 = $var3->templateValue();
...
$setArray = $oldSetArray_e5968317bdc5cfff7634b1369fec243c;
$tpl->Level--;
?>
