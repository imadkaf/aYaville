...
$oldSetArray_da75b3b1b221c0d871d5a12f300b6b8f = isset( $setArray ) ? $setArray : array();
$setArray = array();
$tpl->Level++;
if ( $tpl->Level > 40 )
{
...
<form name="statesform" method="post" action="/index.php/ezdemo_admin/state/assign">
...
unset( $var2 );
unset( $var3 );
$var3 = ( '<a href=' . '"/index.php/ezdemo_admin/state/groups"' . '>' );
if (! isset( $var3 ) ) $var3 = NULL;
while ( is_object( $var3 ) and method_exists( $var3, 'templateValue' ) )
    $var3 = $var3->templateValue();
...
$setArray = $oldSetArray_da75b3b1b221c0d871d5a12f300b6b8f;
$tpl->Level--;
?>
