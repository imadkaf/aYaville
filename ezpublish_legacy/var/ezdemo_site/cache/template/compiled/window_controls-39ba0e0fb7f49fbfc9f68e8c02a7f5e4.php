...
$oldSetArray_4dce5bdd8ef79cb01434ee2f2f0f910c = isset( $setArray ) ? $setArray : array();
$setArray = array();
$tpl->Level++;
if ( $tpl->Level > 40 )
{
...
if ( $if_cond )
{
$text .= '    <div class="button-left"><a id="maincontent-show" class="show-hide-tabs" href="/ezdemo_admin/user/preferences/set/admin_navigation_content/1" title="Enable &quot;Tabs&quot; by default while browsing content.">&nbsp;</a></div>';
}
else
{
$text .= '    <div class="button-left"><a id="maincontent-hide" class="show-hide-tabs" href="/ezdemo_admin/user/preferences/set/admin_navigation_content/0" title="Disable &quot;Tabs&quot; by default while browsing content.">&nbsp;</a></div>';
}
unset( $if_cond );
// if ends
...
$text .= '    </li>
';
$oldRestoreIncludeArray_f53a0c4be3ae8df1c23ece0218fff38d = isset( $restoreIncludeArray ) ? $restoreIncludeArray : array();
...
$resourceFound = false;
if ( file_exists( 'var/ezdemo_site/cache/template/compiled/window_controls_extratabs-dbd80a421eb34720f81a195fb2b9fe7a.php' ) )
{
$resourceFound = true;
...
include( '' . 'var/ezdemo_site/cache/template/compiled/window_controls_extratabs-dbd80a421eb34720f81a195fb2b9fe7a.php' );
...
$restoreIncludeArray = $oldRestoreIncludeArray_f53a0c4be3ae8df1c23ece0218fff38d;
...
$text .= '<div class="tabs-content">
    ';
$oldRestoreIncludeArray_5f0a347c07515008043004a1ca0d5753 = isset( $restoreIncludeArray ) ? $restoreIncludeArray : array();
$restoreIncludeArray = array();
...
$resourceFound = false;
if ( file_exists( 'var/ezdemo_site/cache/template/compiled/windows-f63463fbf1f2916cf52ed07ca40d221c.php' ) )
{
$resourceFound = true;
$namespaceStack[] = array( $rootNamespace, $currentNamespace );
$rootNamespace = $currentNamespace;
...
include( '' . 'var/ezdemo_site/cache/template/compiled/windows-f63463fbf1f2916cf52ed07ca40d221c.php' );
$tpl->unsetLocalVariables();
$tpl->destroyLocalVariablesList();
list( $rootNamespace, $currentNamespace ) = array_pop( $namespaceStack );
}
...
$restoreIncludeArray = $oldRestoreIncludeArray_5f0a347c07515008043004a1ca0d5753;
...
$setArray = $oldSetArray_4dce5bdd8ef79cb01434ee2f2f0f910c;
$tpl->Level--;
?>
