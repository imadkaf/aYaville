...
$oldSetArray_4acd6dc95cbc563c696c2f2252c34d53 = isset( $setArray ) ? $setArray : array();
$setArray = array();
$tpl->Level++;
if ( $tpl->Level > 40 )
{
...
<form action="/ezdemo_admin/content/search" method="get">
    ';
// if begins
unset( $if_cond );
unset( $if_cond );
...
{
$text .= '            <p class="advanced hide"><a href="/ezdemo_admin/content/advancedsearch" title="Advanced search.">Advanced</a></p>
        ';
}
unset( $if_cond );
// if ends
...
$setArray = $oldSetArray_4acd6dc95cbc563c696c2f2252c34d53;
$tpl->Level--;
?>
