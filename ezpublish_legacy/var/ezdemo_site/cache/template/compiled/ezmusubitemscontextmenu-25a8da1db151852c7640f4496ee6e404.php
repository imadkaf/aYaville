...
$oldSetArray_290d2b6f07a292751cba3e9e97e81632 = isset( $setArray ) ? $setArray : array();
$setArray = array();
$tpl->Level++;
if ( $tpl->Level > 40 )
{
...
menuArray[\'SubitemsContextMenu\'][\'elements\'][\'child-menu-multiupload\'][\'url\'] = "/ezdemo_admin/ezmultiupload/upload/%nodeID%";
</script>

<a id="child-menu-multiupload" href="#" onmouseover="ezpopmenu_mouseOver( \'ContextMenu\' )" >Upload multiple files</a>
';

$setArray = $oldSetArray_290d2b6f07a292751cba3e9e97e81632;
$tpl->Level--;
?>
