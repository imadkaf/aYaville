...
$oldSetArray_753b076e0f54074d4ebbea76e7793841 = isset( $setArray ) ? $setArray : array();
$setArray = array();
$tpl->Level++;
if ( $tpl->Level > 40 )
{
...
$text .= '    ';
$oldRestoreIncludeArray_396568da3e611fc8c0dd4b2258a1fcfb = isset( $restoreIncludeArray ) ? $restoreIncludeArray : array();
...
$resourceFound = false;
if ( file_exists( 'var/ezdemo_site/cache/template/compiled/page_topmenuitem-9d068b842fc0582e96f8f41702782a5c.php' ) )
{
$resourceFound = true;
...
include( '' . 'var/ezdemo_site/cache/template/compiled/page_topmenuitem-9d068b842fc0582e96f8f41702782a5c.php' );
...
$restoreIncludeArray = $oldRestoreIncludeArray_396568da3e611fc8c0dd4b2258a1fcfb;
...
$setArray = $oldSetArray_753b076e0f54074d4ebbea76e7793841;
$tpl->Level--;
?>
