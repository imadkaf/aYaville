...
$oldSetArray_e1253dc89acc2c3fd83ff2c3bed056b4 = isset( $setArray ) ? $setArray : array();
$setArray = array();
$tpl->Level++;
if ( $tpl->Level > 40 )
{
...
{
$text .= '
<p>Currently you do not have any pending items available.</p>
';
}
unset( $if_cond );
// if ends
...
$setArray = $oldSetArray_e1253dc89acc2c3fd83ff2c3bed056b4;
$tpl->Level--;
?>
