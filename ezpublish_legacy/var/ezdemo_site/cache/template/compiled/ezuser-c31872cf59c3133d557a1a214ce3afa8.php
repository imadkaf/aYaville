<?php
// URI:       design:content/datatype/view/ezuser.tpl
// Filename:  design/standard/templates/content/datatype/view/ezuser.tpl
// Timestamp: 1416144920 (Sun Nov 16 14:35:20 CET 2014)
$oldSetArray_b0b1505eb77c59b5f8c8f44ce105bec1 = isset( $setArray ) ? $setArray : array();
$setArray = array();
$tpl->Level++;
if ( $tpl->Level > 40 )
{
...
unset( $if_cond );
$if_cond = $if_cond1;
$if_cond1 = compiledFetchAttribute( $if_cond, 'is_locked' );
unset( $if_cond );
$if_cond = $if_cond1;
if (! isset( $if_cond ) ) $if_cond = NULL;
while ( is_object( $if_cond ) and method_exists( $if_cond, 'templateValue' ) )
...
if ( $if_cond )
{
$text .= '	(<span class="userstatus-disabled">locked</span>)
    ';
}
unset( $if_cond );
// if ends
...
$text .= ' title="Enable/disable the user account and set the maximum allowed number of concurrent logins.">Configure user account settings</a></p>';

$setArray = $oldSetArray_b0b1505eb77c59b5f8c8f44ce105bec1;
$tpl->Level--;
?>
