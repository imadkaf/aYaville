...
$oldSetArray_f215dc726d67e104e1b82492c7ddb071 = isset( $setArray ) ? $setArray : array();
$setArray = array();
$tpl->Level++;
if ( $tpl->Level > 40 )
{
...
$text .= ' title="Multiupload"><img class="ezwt-input-image" src="/extension/ezmultiupload/design/standard/images/ezwt-icon-upload.png" alt="Multiupload" /></a>
  ';
}
unset( $if_cond );
// if ends
...
$setArray = $oldSetArray_f215dc726d67e104e1b82492c7ddb071;
$tpl->Level--;
?>
