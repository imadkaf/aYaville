...
$oldSetArray_1e8fb860299d8ee8eaf186e151065747 = isset( $setArray ) ? $setArray : array();
$setArray = array();
$tpl->Level++;
if ( $tpl->Level > 40 )
{
...
$text .= '
<form name="ordering" method="post" action="/ezdemo_admin/content/action">
...
$setArray = $oldSetArray_1e8fb860299d8ee8eaf186e151065747;
$tpl->Level--;
?>
