...
$oldSetArray_6f9122c69b176d788736892c586b0495 = isset( $setArray ) ? $setArray : array();
$setArray = array();
$tpl->Level++;
if ( $tpl->Level > 40 )
{
...
// foreach ends
$text .= '        </ul>
        <form method="post" action="/ezdemo/content/action">
            <fieldset>
...
$setArray = $oldSetArray_6f9122c69b176d788736892c586b0495;
$tpl->Level--;
?>
