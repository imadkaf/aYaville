...
$oldSetArray_eb96e384b2b053077dcde04051b53023 = isset( $setArray ) ? $setArray : array();
$setArray = array();
$tpl->Level++;
if ( $tpl->Level > 40 )
{
...
{
$text .= '    <a href="/ezdemo_admin/content/view/full/2" title="eZ Publish ';
unset( $var );
$var = call_user_func_array( array( new eZSetupFunctionCollection(), 'fetchFullVersionString' ),
  array(  ) );
$var = isset( $var['result'] ) ? $var['result'] : null;
...
$oldRestoreIncludeArray_6a2ac2f323d66b02d82553de48d47911 = isset( $restoreIncludeArray ) ? $restoreIncludeArray : array();
...
$resourceFound = false;
if ( file_exists( 'var/ezdemo_site/cache/template/compiled/page_search-ea0762a5ed77f44ca715c33022650659.php' ) )
{
$resourceFound = true;
...
include( '' . 'var/ezdemo_site/cache/template/compiled/page_search-ea0762a5ed77f44ca715c33022650659.php' );
...
$restoreIncludeArray = $oldRestoreIncludeArray_6a2ac2f323d66b02d82553de48d47911;
...
{
$text .= '    <a href="/ezdemo_admin/user/logout" title="Logout from the system." id="header-usermenu-logout">Logout</a>';
}
unset( $if_cond );
// if ends
...
$setArray = $oldSetArray_eb96e384b2b053077dcde04051b53023;
$tpl->Level--;
?>
