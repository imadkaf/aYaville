...
$oldSetArray_110923a0de0ff9b31d507c2dbc40814c = isset( $setArray ) ? $setArray : array();
$setArray = array();
$tpl->Level++;
if ( $tpl->Level > 40 )
{
...
<form name="loginform" method="post" action="/index.php/ezdemo_admin/user/login">
...
<div class="block">
    ...
    <div class="login-text-wrapper">
        or
        <br/>
        <a href="/index.php/ezdemo_admin/user/register">Register new account</a>
    </div>
</div>
</div></div>
</div>
...
$setArray = $oldSetArray_110923a0de0ff9b31d507c2dbc40814c;
$tpl->Level--;
?>
