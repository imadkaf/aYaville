...
$oldSetArray_264ecb5095db1effebdbf39f16e703b2 = isset( $setArray ) ? $setArray : array();
$setArray = array();
$tpl->Level++;
if ( $tpl->Level > 40 )
{
...
$text .= '",
    editPrefixURL: "/index.php/ezdemo_admin/content/edit",
    rowsPrPage: ';
unset( $var );
unset( $var );
...
$setArray = $oldSetArray_264ecb5095db1effebdbf39f16e703b2;
$tpl->Level--;
?>
