...
$oldSetArray_cf834fafe8e886c5d35391e5eb63b621 = isset( $setArray ) ? $setArray : array();
$setArray = array();
$tpl->Level++;
if ( $tpl->Level > 40 )
{
...
$text .= ' title="Timeline"><img class="ezwt-input-image" src="/extension/ezflow/design/ezflow/images/websitetoolbar/ezwt-icon-timeline.png" alt="Timeline" /></a>';
}
unset( $if_cond );
// if ends


$setArray = $oldSetArray_cf834fafe8e886c5d35391e5eb63b621;
$tpl->Level--;
?>
