...
$oldSetArray_32137393c8a8173779954124c4811c06 = isset( $setArray ) ? $setArray : array();
$setArray = array();
$tpl->Level++;
if ( $tpl->Level > 40 )
{
...
menuArray[\'BookmarkMenu\'][\'elements\'][\'bookmark-view\'] = { \'url\': "/index.php/ezdemo_admin/content/view/full/%nodeID%" };
menuArray[\'BookmarkMenu\'][\'elements\'][\'bookmark-edit\'] = { \'url\': "/index.php/ezdemo_admin/content/edit/%objectID%" };
</script>
...
<form id="menu-form-removebookmark" method="post" action="/index.php/ezdemo_admin/content/bookmark">
...
$setArray = $oldSetArray_32137393c8a8173779954124c4811c06;
$tpl->Level--;
?>
