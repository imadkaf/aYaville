<?php
// URI:       design:tabs/user/policies_header.tpl
// Filename:  design/admin/templates/tabs/user/policies_header.tpl
// Timestamp: 1416144920 (Sun Nov 16 14:35:20 CET 2014)
$oldSetArray_801f27047a6798f8599083d6b7c78062 = isset( $setArray ) ? $setArray : array();
$setArray = array();
$tpl->Level++;
if ( $tpl->Level > 40 )
{
...
unset( $var3 );
unset( $var3 );
$var3 = ( array_key_exists( $rootNamespace, $vars ) and array_key_exists( 'assigned_policies', $vars[$rootNamespace] ) ) ? $vars[$rootNamespace]['assigned_policies'] : null;
...
$text .= ' title="Show policy overview.">';
unset( $var );
unset( $var2 );
unset( $var3 );
unset( $var3 );
...
$setArray = $oldSetArray_801f27047a6798f8599083d6b7c78062;
$tpl->Level--;
?>
