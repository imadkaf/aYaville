...
$oldSetArray_743b63653cf17e0822239f420c96b068 = isset( $setArray ) ? $setArray : array();
$setArray = array();
$tpl->Level++;
if ( $tpl->Level > 40 )
{
...
$var2 = array( '%edition' => $var3, '%about_link' => "\"/ezdemo_admin/ezinfo/about\"" );unset( $var3 );
...
$setArray = $oldSetArray_743b63653cf17e0822239f420c96b068;
$tpl->Level--;
?>
